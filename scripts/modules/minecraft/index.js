...
var config = { 
    commandPrefix: "m!" //Our custom command prefix
};
...
Minecraft.World.events.tick.subscribe(() => { //Run stuff inside every world tick
    ...
    utils.runCommand(`tellraw @a {"rawtext":[{"text":"§eMR GameTest Framework Pack\n\n§dType §a${config.commandPrefix}help §dfor more information!"}]}`);
    //utils.setTickInterval(startupFunctions, 20);
    tickExeOnce++;
});

//An example on how you can create a leaderboard. Check out the function parameter comments for "writeLeaderboard" in the file utils/misc.js for more information on how to get it setup.
/*
